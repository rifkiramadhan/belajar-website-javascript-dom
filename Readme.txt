...
1. Menurut Mozilla:
    - "DOM adalah antarmuka pemrograman untuk HTML yang merepresentasikan halaman
       web, sehingga program dapat mengubah dan memanipulasi strukturnya"
...
4. Materi di source code ini:
    ...
    - Event Handling
        - Bagaimana melakukan perubahan pada DOM atau menelusuri DOM karena ada trigger, misalkan mousticklick,
          kursor digerakkan, dll
    - Studi Kasus
        - Membuat program2 sederhana kalkulator sederhana, dan slide show, serta game sederhana menggunakan konsep DOM

5. Materi yang wajib dipahami terlebih dahulu:
    - HTML
    - CSS
    - JavaScript